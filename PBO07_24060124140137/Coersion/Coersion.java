...
public class Coersion {
    public static void main(String[] args) {
        ...
        System.out.println("x berupa char : " + (char) x);  // int to char
        System.out.println("x berupa real : " + (double) x); // int to real
        
        
        System.out.println("\nBagian B");
        int a = 20;
        double b = a; // int to real
        int c = (int) b;
